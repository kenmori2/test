...
class vector
{
    public:
        ...
        virtual void print( )const{
            if(num==0)std::cout<<"Empty"<<std::endl;
            else{
        ...
        T& operator []( int index ){
            if(index < 0 || index >= num)throw "out of range";
            return x[index];
        }
...
class matrix : public vector<T>
{
    public:
        ...
        T& operator ()( int r, int c ){ 
            if(r + c * num1>num1*num2-1||r + c * num1<0)throw "out of range";
        ...
        void print( )const{
            if(num1==0&&num2==0)std::cout<<"Empty"<<std::endl;
            else{
